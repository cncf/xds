...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CELEXPRESSION']._serialized_end=536
  _globals['_CELEXTRACTSTRING']._serialized_start=539
  _globals['_CELEXTRACTSTRING']._serialized_end=670
