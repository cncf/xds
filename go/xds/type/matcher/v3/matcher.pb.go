...
type Matcher_MatcherList_Predicate struct {
	...
	//	*Matcher_MatcherList_Predicate_OrPredicates
	//	*Matcher_MatcherList_Predicate_AndPredicates
	//	*Matcher_MatcherList_Predicate_NotPredicate
...
func (x *Matcher_MatcherList_Predicate) GetOrPredicates() *Matcher_MatcherList_Predicate_PredicateList {
	if x, ok := x.GetMatchType().(*Matcher_MatcherList_Predicate_OrPredicates); ok {
		return x.OrPredicates
	}
	return nil
}

func (x *Matcher_MatcherList_Predicate) GetAndPredicates() *Matcher_MatcherList_Predicate_PredicateList {
	if x, ok := x.GetMatchType().(*Matcher_MatcherList_Predicate_AndPredicates); ok {
		return x.AndPredicates
	}
	return nil
}

func (x *Matcher_MatcherList_Predicate) GetNotPredicate() *Matcher_MatcherList_Predicate {
	if x, ok := x.GetMatchType().(*Matcher_MatcherList_Predicate_NotPredicate); ok {
...
type Matcher_MatcherList_Predicate_OrPredicates struct {
	OrPredicates *Matcher_MatcherList_Predicate_PredicateList `protobuf:"bytes,2,opt,name=or_predicates,json=orPredicates,proto3,oneof"`
}

type Matcher_MatcherList_Predicate_AndPredicates struct {
	AndPredicates *Matcher_MatcherList_Predicate_PredicateList `protobuf:"bytes,3,opt,name=and_predicates,json=andPredicates,proto3,oneof"`
}

type Matcher_MatcherList_Predicate_NotPredicate struct {
	NotPredicate *Matcher_MatcherList_Predicate `protobuf:"bytes,4,opt,name=not_predicate,json=notPredicate,proto3,oneof"`
}

func (*Matcher_MatcherList_Predicate_SinglePredicate_) isMatcher_MatcherList_Predicate_MatchType() {}

func (*Matcher_MatcherList_Predicate_OrPredicates) isMatcher_MatcherList_Predicate_MatchType() {}

func (*Matcher_MatcherList_Predicate_AndPredicates) isMatcher_MatcherList_Predicate_MatchType() {}

func (*Matcher_MatcherList_Predicate_NotPredicate) isMatcher_MatcherList_Predicate_MatchType() {}
...
type Matcher_MatcherList_Predicate_PredicateList struct {
	...
	List []*Matcher_MatcherList_Predicate `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *Matcher_MatcherList_Predicate_PredicateList) GetList() []*Matcher_MatcherList_Predicate {
	if x != nil {
		return x.List
	}
	return nil
...
var file_xds_type_matcher_v3_matcher_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x86, 0x10, 0x0a, 0x07, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x12, 0x4d, 0x0a,
	...
	0x12, 0x03, 0xf8, 0x42, 0x01, 0x1a, 0xbc, 0x08, 0x0a, 0x0b, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65,
	...
	0x72, 0x73, 0x1a, 0x97, 0x06, 0x0a, 0x09, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65,
	...
	0x65, 0x12, 0x67, 0x0a, 0x0d, 0x6f, 0x72, 0x5f, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74,
	0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x78, 0x64, 0x73, 0x2e, 0x74,
	...
	0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0c, 0x6f, 0x72,
	0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x12, 0x69, 0x0a, 0x0e, 0x61, 0x6e,
	0x64, 0x5f, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x40, 0x2e, 0x78, 0x64, 0x73, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x6d, 0x61,
	0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72,
	...
	0x4c, 0x69, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0d, 0x61, 0x6e, 0x64, 0x50, 0x72, 0x65, 0x64, 0x69,
	0x63, 0x61, 0x74, 0x65, 0x73, 0x12, 0x59, 0x0a, 0x0d, 0x6e, 0x6f, 0x74, 0x5f, 0x70, 0x72, 0x65,
	0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x78,
	...
	0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x1a, 0x61, 0x0a, 0x0d, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x50, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x78, 0x64, 0x73, 0x2e, 0x74, 0x79, 0x70, 0x65,
	...
	0x02, 0x08, 0x02, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x11, 0x0a, 0x0a, 0x6d, 0x61, 0x74,
	0x63, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x1a, 0xb5, 0x01, 0x0a,
	0x0c, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x12, 0x5a, 0x0a,
	0x09, 0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x32, 0x2e, 0x78, 0x64, 0x73, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x6d, 0x61, 0x74, 0x63,
	...
	0x70, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x49, 0x0a, 0x08, 0x6f, 0x6e, 0x5f,
	...
	,
	...
	0x68, 0x4d, 0x61, 0x70, 0x12, 0x5d, 0x0a, 0x10, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x5f, 0x6d,
	0x61, 0x74, 0x63, 0x68, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31,
	0x2e, 0x78, 0x64, 0x73, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65,
	...
	0x70, 0x48, 0x00, 0x52, 0x0e, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x4d, 0x61, 0x74, 0x63, 0x68,
	0x4d, 0x61, 0x70, 0x12, 0x46, 0x0a, 0x0c, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x6d, 0x61,
	0x74, 0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x78, 0x64, 0x73, 0x2e,
	...
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x1a, 0xc0, 0x01, 0x0a, 0x08,
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x4d, 0x61, 0x70, 0x12, 0x56, 0x0a, 0x03, 0x6d, 0x61, 0x70, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x78, 0x64, 0x73, 0x2e, 0x74, 0x79, 0x70, 0x65,
	0x2e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4d, 0x61, 0x74, 0x63,
	...
	0x1a, 0x5c, 0x0a, 0x08, 0x4d, 0x61, 0x70, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
	...
	0x74, 0x63, 0x68, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x10,
	0x0a, 0x09, 0x74, 0x72, 0x65, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x12, 0x03, 0xf8, 0x42, 0x01,
	0x3a, 0x08, 0xd2, 0xc6, 0xa4, 0xe1, 0x06, 0x02, 0x08, 0x01, 0x42, 0x0e, 0x0a, 0x0c, 0x6d, 0x61,
...
var file_xds_type_matcher_v3_matcher_proto_depIdxs = []int32{
	...
	7,  // 11: xds.type.matcher.v3.Matcher.MatcherList.Predicate.or_predicates:type_name -> xds.type.matcher.v3.Matcher.MatcherList.Predicate.PredicateList
	7,  // 12: xds.type.matcher.v3.Matcher.MatcherList.Predicate.and_predicates:type_name -> xds.type.matcher.v3.Matcher.MatcherList.Predicate.PredicateList
	4,  // 13: xds.type.matcher.v3.Matcher.MatcherList.Predicate.not_predicate:type_name -> xds.type.matcher.v3.Matcher.MatcherList.Predicate
	...
	4,  // 19: xds.type.matcher.v3.Matcher.MatcherList.Predicate.PredicateList.list:type_name -> xds.type.matcher.v3.Matcher.MatcherList.Predicate
...
func file_xds_type_matcher_v3_matcher_proto_init() {
	...
	file_xds_type_matcher_v3_matcher_proto_msgTypes[4].OneofWrappers = []interface{}{
		...
		(*Matcher_MatcherList_Predicate_OrPredicates)(nil),
		(*Matcher_MatcherList_Predicate_AndPredicates)(nil),
		(*Matcher_MatcherList_Predicate_NotPredicate)(nil),
	}
